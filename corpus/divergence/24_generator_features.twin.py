...
result = []
for v in only_odd(squares(naturals(10))):
    result.append(v)
print(result)
...
collected = []
for v in until_negative([1, 2, 3, -1, 4, 5]):
    collected.append(v)
print(collected)
